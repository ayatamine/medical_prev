<template>
    <jig-layout>
        <template #header>
            ...
            >
                <inertia-link
                    :href="route('admin.scale-answers.index')"
                    class="text-2xl font-black text-white"
                ><i class="fas fa-arrow-left"></i> Back | Details of Scale Answer
        ...
        <div v-if="model.can.view" class="flex flex-wrap px-4">
            ...
            >
                <show-scale-answers-form :model="model"></show-scale-answers-form>
            </div>
        </div>
...
<script>
    ...
    import ShowScaleAnswersForm from "./ShowForm.vue"
    import { defineComponent } from "vue";

    export default defineComponent({
        name: "ShowScaleAnswer",
        components: {
            InertiaButton,
            JigLayout,
