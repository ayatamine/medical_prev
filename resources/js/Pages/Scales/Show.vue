<template>
    <jig-layout>
        <template #header>
            ...
            >
                <inertia-link
                    :href="route('admin.scales.index')"
                    class="text-2xl font-black text-white"
                ><i class="fas fa-arrow-left"></i> Back | Details of Scale
        ...
        <div v-if="model.can.view" class="flex flex-wrap px-4">
            ...
            >
                <show-scales-form :model="model"></show-scales-form>
            </div>
        </div>
...
<script>
    ...
    import ShowScalesForm from "./ShowForm.vue"
