<template>
    <jig-layout>
        <template #header>
            ...
            >
                <inertia-link
                    :href="route('admin.family-histories.index')"
                    class="text-2xl font-black text-white"
                ><i class="fas fa-arrow-left"></i> Back | Details of Family History
        ...
        <div v-if="model.can.view" class="flex flex-wrap px-4">
            ...
            >
                <show-family-histories-form :model="model"></show-family-histories-form>
            </div>
        </div>
...
<script>
    ...
    import ShowFamilyHistoriesForm from "./ShowForm.vue"
    import { defineComponent } from "vue";

    export default defineComponent({
        name: "ShowFamilyHistory",
        components: {
            InertiaButton,
            JigLayout,
