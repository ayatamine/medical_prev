<template>
    <form @submit.prevent="updateModel">
            ...
            <jet-checkbox class="p-2" type="checkbox" id="notification_status" name="notification_status" :checked="form.notification_status" v-model="form.notification_status"
            ...
            <jet-checkbox class="p-2" type="checkbox" id="has_physical_activity" name="has_physical_activity" :checked="form.has_physical_activity" v-model="form.has_physical_activity"
            ...
            <jet-checkbox class="p-2" type="checkbox" id="has_cancer_screening" name="has_cancer_screening" :checked="form.has_cancer_screening" v-model="form.has_cancer_screening"
            ...
            <jet-checkbox class="p-2" type="checkbox" id="has_depression_screening" name="has_depression_screening" :checked="form.has_depression_screening" v-model="form.has_depression_screening"
            ...
            <jet-checkbox class="p-2" type="checkbox" id="account_status" name="account_status" :checked="form.account_status" v-model="form.account_status"
            ...
            <jet-input-error :message="form.errors.age" class="mt-2" />
                    ...
                    <infinite-select class="w-full" :per-page="15" :api-url="route('api.family-histories.index')"
                    ...
                    <infinite-select class="w-full" :per-page="15" :api-url="route('api.chronic-diseases.index')"
                    ...
                    <infinite-select class="w-full" :per-page="15" :api-url="route('api.allergies.index')"
