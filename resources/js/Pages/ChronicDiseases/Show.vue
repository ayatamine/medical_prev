<template>
    <jig-layout>
        <template #header>
            ...
            >
                <inertia-link
                    :href="route('admin.chronic-diseases.index')"
                    class="text-2xl font-black text-white"
                ><i class="fas fa-arrow-left"></i> Back | Details of Chronic Disease
        ...
        <div v-if="model.can.view" class="flex flex-wrap px-4">
            ...
            >
                <show-chronic-diseases-form :model="model"></show-chronic-diseases-form>
            </div>
        </div>
...
<script>
    ...
    import ShowChronicDiseasesForm from "./ShowForm.vue"
    import { defineComponent } from "vue";

    export default defineComponent({
        name: "ShowChronicDisease",
        components: {
            InertiaButton,
            JigLayout,
