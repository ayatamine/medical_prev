<template>
    <jig-layout>
        <template #header>
            ...
            >
                <inertia-link
                    :href="route('admin.scale-questions.index')"
                    class="text-2xl font-black text-white"
                ><i class="fas fa-arrow-left"></i> Back | Details of Scale Question
        ...
        <div v-if="model.can.view" class="flex flex-wrap px-4">
            ...
            >
                <show-scale-questions-form :model="model"></show-scale-questions-form>
            </div>
        </div>
...
<script>
    ...
    import ShowScaleQuestionsForm from "./ShowForm.vue"
    import { defineComponent } from "vue";

    export default defineComponent({
        name: "ShowScaleQuestion",
        components: {
            InertiaButton,
            JigLayout,
