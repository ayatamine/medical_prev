<template>
    <form @submit.prevent="updateModel">
            ...
            <jet-input-error :message="form.errors.question_ar" class="mt-2" />
                    ...
                    <infinite-select class="w-full" :per-page="15" :api-url="route('api.scales.index')"
                                     id="scale" name="scale"
...
<script>
    ...
    export default defineComponent({
        ...
        methods: {
            async updateModel() {
                this.form.put(this.route('admin.scale-questions.update',this.form.id),
                    {
                        onSuccess: res => {
