    ...
    <jig-layout>
        <template #header>
            ...
            >
                ...
                ><i class="fas fa-arrow-left"></i> Back | Details of Recommendation
        ...
        <div v-if="model.can.view" class="flex flex-wrap px-4">
            ...
            >
                <show-recommendations-form :model="model"></show-recommendations-form>
            </div>
        </div>
...
<script>
    ...
    import ShowRecommendationsForm from "./ShowForm.vue"
