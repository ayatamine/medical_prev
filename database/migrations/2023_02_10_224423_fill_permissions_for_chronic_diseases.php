...
class FillPermissionsForChronicDiseases extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForChronicDiseases constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'Chronic Diseases Module' => 'chronic-diseases',
            'List All Chronic Diseases' => 'chronic-diseases.index',
            'Create New Chronic Diseases' => 'chronic-diseases.create',
            'View Any Chronic Disease' => 'chronic-diseases.show',
            'Edit or Update a Single Chronic Disease' => 'chronic-diseases.edit',
            'Delete Chronic Diseases' => 'chronic-diseases.delete',
        ]);
