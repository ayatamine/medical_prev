...
class FillPermissionsForFamilyHistories extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForFamilyHistories constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'Family Histories Module' => 'family-histories',
            'List All Family Histories' => 'family-histories.index',
            'Create New Family Histories' => 'family-histories.create',
            'View Any Family History' => 'family-histories.show',
            'Edit or Update a Single Family History' => 'family-histories.edit',
            'Delete Family Histories' => 'family-histories.delete',
        ]);
