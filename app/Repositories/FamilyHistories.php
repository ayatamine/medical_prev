...
{
    private FamilyHistory $model;
    public static function init(FamilyHistory $model): FamilyHistories
    {
        $instance = new self;
    ...
    public static function store(object $data): FamilyHistory
    {
        $model = new FamilyHistory((array) $data);
                // Save Relationships
    ...
    public function show(Request $request): FamilyHistory {
        //Fetch relationships
            return $this->model;
    }
    public function update(object $data): FamilyHistory
    {
    ...
    public static function dt($query) {
        return DataTables::of($query)
            ->editColumn('actions', function (FamilyHistory $model) {
                $actions = '';
