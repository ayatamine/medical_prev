...
{
    private Ad $model;
    public static function init(Ad $model): Ads
    {
        $instance = new self;
    ...
    public static function store(object $data): Ad
    {
        $model = new Ad((array) $data);
                // Save Relationships
    ...
    public function update(object $data): Ad
    {
    ...
    public static function dt($query) {
        return DataTables::of($query)
            ->editColumn('actions', function (Ad $model) {
                $actions = '';
