...
{
    private Scale $model;
    public static function init(Scale $model): Scales
    {
        $instance = new self;
    ...
    public static function store(object $data): Scale
    {
        $model = new Scale((array) $data);
                // Save Relationships
    ...
    public function show(Request $request): Scale {
        //Fetch relationships
            return $this->model;
    }
    public function update(object $data): Scale
    {
    ...
    public static function dt($query) {
        return DataTables::of($query)
            ->editColumn('actions', function (Scale $model) {
                $actions = '';
