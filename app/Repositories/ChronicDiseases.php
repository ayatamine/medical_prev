...
{
    private ChronicDisease $model;
    public static function init(ChronicDisease $model): ChronicDiseases
    {
        $instance = new self;
    ...
    public static function store(object $data): ChronicDisease
    {
        $model = new ChronicDisease((array) $data);
                // Save Relationships
    ...
    public function show(Request $request): ChronicDisease {
        //Fetch relationships
            return $this->model;
    }
    public function update(object $data): ChronicDisease
    {
    ...
    public static function dt($query) {
        return DataTables::of($query)
            ->editColumn('actions', function (ChronicDisease $model) {
                $actions = '';
